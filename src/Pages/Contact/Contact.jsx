...
const Contact = () => {
    return (
        <div data-aos="flip-left"
            ...
            className="contact-bg rounded-xl h-[calc(100vh-50px)] shadow-lg overflow-hidden sticky top-6 p-6 lg:px-24 lg:py-12 text-slate-300">
            <Scrollbars autoHide
                autoHideTimeout={500}
                ...
                <div className='mt-10 flex flex-col md:flex-row gap-2'>
                    <div className='w-full md:w-1/2 space-y-4 mb-4'>
                    ...
                    <div className='w-full md:w-1/2 bg-gray-500 bg-opacity-30 rounded-lg'>
                        <form className="p-4">
