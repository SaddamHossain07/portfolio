...
const Layout = () => {
    return (
        <div className='max-w-7xl mx-auto p-6 flex flex-col lg:flex-row bg-white'>
            {/* left element  */}
            <div className='w-full lg:w-3/12 mx-auto flex justify-center overflow-hidden lg:mr-10'>
                <div
                    data-aos="fade-right"
                    data-aos-offset="300"
                    data-aos-delay="200"
                    ...
                    className="sticky lg:fixed top-6 left-6">
                    <div className="w-[300px]">
                        ...
                        <div className="mt-6">
                            <h3 className="text-[32px] text-center text-gray-700 font-black">Saddam Hossain</h3>
